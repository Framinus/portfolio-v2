    ...
    this.state = {
      mediumArticles: [
        ...
        },
        {
          ...
          teaser: 'In part two of this series, we deploy the application to Heroku and use the Heroku Bash CLI tool to set up the database on the server. I also talk about how to target deployment errors in your app using Heroku Logs.',
        }
      ]
    }
  }
